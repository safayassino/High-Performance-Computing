...
blis = pd.read_csv('THIN-openblas-matrix.csv')
openblas = pd.read_csv('THIN-blis-matrix.csv')
...
fig.suptitle('GEMM Performance - Fixed Matrix (10000x10000) on THIN node', fontsize=14, fontweight='bold', y=0.98)
plt.tight_layout()
plt.show()
